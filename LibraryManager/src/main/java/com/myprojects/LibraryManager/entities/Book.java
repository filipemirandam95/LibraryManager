...
public class Book {
    ...
    public Book(BookRequestDTO bookRequestDTO) {
        ...
        this.edition = bookRequestDTO.getEdition();
        this.totalCopies = bookRequestDTO.getTotalCopies();
        this.availableCopies = bookRequestDTO.getAvailableCopies();

        for (CategoryRequestDTO category : bookRequestDTO.getCategories()) {
